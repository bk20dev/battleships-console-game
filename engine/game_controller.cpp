...
void engine::game_controller::handle_opponent_disconnected() const
{
...
void engine::game_controller::handle_opponent_battleship_placement_submitted()
{
    opponent_player.set_board_ready();
...
{
    current_player = player(
        [this](const core::position&)
        {
            // TODO:
        },
        [this](const models::battleship&)
        {
            // TODO:
        }
    );
