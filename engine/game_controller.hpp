...
namespace engine
{
    class game_controller final
    {
        ...
        void handle_opponent_player_shot_received(const models::position&);
        void handle_current_player_battleship_part_damaged(const models::position&) const;
        void handle_current_player_battleship_destroyed(const models::battleship&) const;
        void handle_opponent_player_battleship_part_damaged(const models::position&);
    ...
    public:
        ...
        void shoot_opponent_player(const models::position&);
